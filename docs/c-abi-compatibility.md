...
- XPUB manual-last value delivery and only-first-subscribe multipart forwarding semantics remain incomplete beyond option validation and covered inproc notification/manual accept behavior.
