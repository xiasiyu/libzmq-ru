...
- Hello lifecycle messages now deliver over inproc pipes and active TCP/IPC ZMTP handshake paths; receiver-side disconnect messages deliver over inproc pipes. TCP/IPC disconnect/hiccup delivery and fully asynchronous TCP/IPC hello delivery without an active socket operation remain incomplete.
