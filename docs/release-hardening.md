...
- XPUB/XSUB default and `ZMQ_XPUB_VERBOSE` inproc subscription notifications are covered, but manual-last, verboser unsubscribe, and only-first-subscribe multipart forwarding semantics remain incomplete.
